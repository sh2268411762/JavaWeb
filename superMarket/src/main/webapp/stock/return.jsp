...
<CENTER>
    ...
    <%
        try
        {
            ...
            rs = stmt.executeQuery("SELECT * FROM tb_return_single"); //建立ResultSet(结果集)对象，并执行SQL语句
            rs.last(); //移至最后一条记录
...
<div class="href">
    <button class="btn btn-danger"><a id="stock-href" href="stock.html"><span>上一界面</span></a></button>
