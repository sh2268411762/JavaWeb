...
<CENTER>
    ...
    <%
        try
        {
            ...
            rs = stmt.executeQuery("SELECT * FROM tb_provider"); //建立ResultSet(结果集)对象，并执行SQL语句
            rs.last(); //移至最后一条记录
